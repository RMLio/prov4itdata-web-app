...
- [PROV4ITDaTa - Technical Report](#prov4itdata---technical-report)
  ...
  - [Adding data providers](#adding-data-providers-1)
  - [Features](#features)
...
3. In the third step, the [Web App](#web-app) finalizes the data transfer by storing the [RDF] and [provenance] data, generated by the [RMLMapper-JAVA], to the Solid pod.
